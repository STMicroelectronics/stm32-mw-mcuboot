...
#define ROM_FIXED_0_ID                  (0x0)
#define ROM_FIXED_1_ID                  (0x1)
#define ROM_FIXED_4_ID                  (0x2)
#define ROM_FIXED_5_ID                  (0x3)
...
#define FLASH_AREA_IMAGE_SECONDARY(x)   (((x) == 0) ? FLASH_AREA_2_ID : \
                                                      FLASH_AREA_2_ID)
#define ROM_FIXED_TO_IMAGE_IDX(x)       (((x) == ROM_FIXED_0_ID) ? 0 : \
                                                                   0)
...
/* Get the primary slot corresponding to the ROM fixed ID x */
#define FLASH_AREA_PRIMARY_ROM_FIXED(x) FLASH_AREA_IMAGE_PRIMARY(ROM_FIXED_TO_IMAGE_IDX(x))
